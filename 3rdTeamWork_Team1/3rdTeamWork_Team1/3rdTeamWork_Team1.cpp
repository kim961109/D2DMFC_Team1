// 3rdTeamWork_Team1.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "3rdTeamWork_Team1.h"
#include "MainGame.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY3RDTEAMWORK_TEAM1, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY3RDTEAMWORK_TEAM1));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY3RDTEAMWORK_TEAM1));
