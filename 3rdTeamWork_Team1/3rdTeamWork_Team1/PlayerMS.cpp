...
int CPlayerMS::Update(void)
{
	...
	for (int i = 0; i < 4; ++i)
	{
		...
		m_vPoint[i] -= m_vFirstPos;// {200.f, 100.f, 0.f};
		//m_vPoint[i] -= {200.f, 100.f, 0.f};
		//D3DXVec3TransformCoord(&m_vPoint[i], &m_vPoint[i], &m_tInfo.matWorld);
	}
	for (int i = 0; i < 4; ++i)
	{
		m_vleftPoint[i] = m_vOriginleftPoint[i];
		m_vleftPoint[i] -= m_vFirstPos;// { 200.f, 100.f, 0.f};
	...
	for (int i = 0; i < 4; ++i)
	{
		...
		m_vrightPoint[i] -= m_vFirstPos;// { 200.f, 100.f, 0.f};
	...
	for (int i = 0; i < 4; ++i)
	{
		...
		m_vleftDownPoint[i] -= m_vFirstPos;// { 200.f, 100.f, 0.f};
	...
	for (int i = 0; i < 4; ++i)
	{
		...
		m_vrightDownPoint[i] -= m_vFirstPos;// { 200.f, 100.f, 0.f};
	...
	cout << "ÇÃ·¹ÀÌ¾î DIRÁÂÇ¥ : " << m_tInfo.vDir.x << "\t" << m_tInfo.vDir.y << "\t" << m_tInfo.vDir.z << endl;
	cout << "ÇÃ·¹ÀÌ¾î POSÁÂÇ¥ : " << m_tInfo.vPos.x << "\t" << m_tInfo.vPos.y << "\t" << m_tInfo.vPos.z << endl;
...
{
	//cout << "ÇÃ·¹ÀÌ¾î ÁÂÇ¥" << m_tInfo.vPos.x << m_tInfo.vPos.y << endl;
